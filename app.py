...
if comp:
    ...
    if match:
        ...
        pass_rate_player0=pass_rate_player0.sort_values(by='Successful Passes', ascending=False, inplace=True).reset_index(drop=True)
        ...
        pass_rate_player1=pass_rate_player1.sort_values(by='Successful Passes', ascending=False, inplace=True).reset_index(drop=True)
