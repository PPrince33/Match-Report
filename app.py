...
if comp:
    ...
    if match:
        ...
        with col1:
            ...
            st.write("Average Passes per Minute", round(pass_df0['Pass_Result'].sum() / event_df[event_df.type == 'Pass']['minute'].max()))
        ...
        with col2:             
            ...
            st.write("Average Passes per Minute", round(pass_df1['Pass_Result'].sum() / event_df[event_df.type == 'Pass']['minute'].max()))
