...
if comp:
    ...
    if match:
        ...
        ax.barh(y=0, width=poss0,left=5 ,color='#DEEFF5', label=f'{team_name0} - {poss0 * 100:.1f}%')
        ax.barh(y=0, width=poss1, left=poss0+5, color='#90EE90', label=f'{team_name1} - {poss1 * 100:.1f}%')
        ax.axis('off')
